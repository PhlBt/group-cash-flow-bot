...
- ✅ Присоединение игроков к играм
- ✅ Бросок кубика и перемещение по доске
- ✅ Обработка полей: PAYDAY, DEAL, MISCELLANEOUS, CHILD, CHARITY, DISMISSAL, MARKET
- ✅ Рыночные события (MARKET поле с циркуляцией карт)
- ✅ Система активов и пассивов игроков
- ✅ Финансовые операции (покупка, продажа, кредиты)
- ✅ Банкротство и восстановление с продажей активов
- ✅ Статистика игроков
- ✅ Система благотворительности (пожертвование за бонус)
- ✅ Предложение сделок другим игрокам с комиссией
- ✅ Автоматический переход на Fast Track при выполнении условия passiveIncome > totalExpenses
- ✅ Скоростная дорожка (Fast Track) с уникальными полями и событиями
- ✅ Выбор мечты при переходе на Fast Track
- ✅ Покупка мечтаний с механикой удвоения стоимости для чужих мечтаний
- ✅ Автоматическая победа при достижении fastTrackIncome >= dreamCost
...
│   │       └── fastTrack.js    # Карты скоростной дорожки
│   ├── services/
